...
pub async fn draw(Query(params): Query<HashMap<String, String>>, mut multipart: Multipart) -> impl IntoResponse {
...
fn get_base_colors_info(buffer: &Vec<u8>, number_of_clusters: u32, max_try_count: u32) -> Result<Vec<ColorPoint>, ImageError> {
...
fn get_png_image_with_base_colors(buffer: &Vec<u8>, number_of_clusters: u32, max_try_count: u32) -> Result<Vec<u8>, ImageError> {
